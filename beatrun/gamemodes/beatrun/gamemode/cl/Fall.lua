...
-- sound.Add( {
	...
	-- level = 80,
	-- pitch = 100,
	-- sound = {"heartbeat_beat_01.wav",
	-- "heartbeat_beat_02.wav",
	-- "heartbeat_beat_03.wav",
	-- "heartbeat_beat_04.wav",
	-- "heartbeat_beat_05.wav",
	-- "heartbeat_beat_06.wav",
	-- "heartbeat_beat_07.wav",
	-- "heartbeat_beat_08.wav"}
-- } )
...
hook.Add("HUDPaint", "FallVignette", function()
	if !LocalPlayer().FallStatic then return end
